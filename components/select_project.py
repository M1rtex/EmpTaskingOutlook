...
################################################################################
## Form generated from reading UI file 'select_project.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.projects_listWidget = QListWidget(self.frame)
        self.projects_listWidget.setObjectName(u"projects_listWidget")
        self.projects_listWidget.setGeometry(QRect(50, 40, 491, 271))
        self.projects_listWidget.setEditTriggers(QAbstractItemView.NoEditTriggers)
